...
//    mMachine = GetPicture()->GetMachine();
    ...
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnEditMachineNumber, this, XRCID("EditMachine1Number"));
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnEditMachine2Number, this, XRCID("EditMachine2Number"));
...
/**
 * Edit machine 1 number
 * @param event
 */
void ViewEdit::OnEditMachineNumber(wxCommandEvent &event)
{
    mMachine = GetPicture()->GetMachine();
    mMachine->ShowDialogBox(this->GetParent());
}
/**
 * Edit machine 2 number
 * @param event
 */
void ViewEdit::OnEditMachine2Number(wxCommandEvent &event)
{
    mMachine2 = GetPicture()->GetMachine2();
    mMachine2->ShowDialogBox(this->GetParent());
}
